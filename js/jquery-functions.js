$("document").ready(function () {
  ...
  function retrieveAnswers() {
    ...
    // Function to check if all first five answers are "1"
function checkFirstFiveAnswers() {
  for (var i = 0; i < 5; i++) {
    if (allAnswers[i] !== "1") {
      return false;
    }
...
if (checkFirstFiveAnswers()) {
  ...
  getEvidencesById(5);
  currentLanguage === "greek"
    ? setResult("Δικαιούστε τα εξής δικαιολογητικά:")
    : setResult("You are entitled to the following evidences:");
} else {
  currentLanguage === "greek"
    ? setResult("Δεν δικαιούστε το επίδομα.")
    : setResult("You are not entitled to the benefit.");
}
  ...
  function submitForm() {
    ...
    currentLanguage === "greek"
      ? $(".question-container").append(
          "<br /><br /><h5 class='answer'>Τα δικαιολογητικά που πρέπει να προσκομίσετε για να πάρετε επίδομα ανεργίας είναι τα εξής:</h5><br />"
        )
      : $(".question-container").append(
          "<br /><br /><h5 class='answer'>The supporting documents you must provide to receive unemployment benefit are as follows:</h5><br />"
        );
